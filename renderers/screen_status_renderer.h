 ...
 * owns display arbitration: direct sinks must wait for other video owners to
 * release. In compositor mode the Wayland background stays mapped underneath
 * transient media surfaces until receiver shutdown.
